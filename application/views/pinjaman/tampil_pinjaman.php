...
<div class="agile-grids">	
				...
				<div class="agile-tables">
				  ...
				  <h3><a style="margin-left:15px; margin-top:10px;" href="input_pinjaman" class="fa fa-plus"><i class="btn-icon-only/ icon-plus"> </i>Tambah Data</a></h3>
				  <?php
...
return $m;
				  ...
				  <table width="100%" id="example1" class="max-height">
					<thead>
					  <tr>
						<th width="1%"><center>ID</th>
						<th width="21%"><center>Nama</th>
						
						<th width="15%"><center>Total Pinjaman</th>
						<th width="15%"><center>Sisa</th>
						<th width="3%"><center>Tenor</th>
						<th width="3%"><center>Status</th>
						<th width="12%"><center>Tgl Pelunasan</th>
						<th><center>Aksi</th>
					  </tr>
					</thead>
					<tbody>
					<?php foreach ($ambil as $data) {
					  ...
					  <tr>
					  <?php 
					  if ($data->status_pinjaman == 'Lunas') {
					  ?>
						<td><?php echo $data->id_pinjaman ?></td>
						<td><?php echo $data->nama ?></td>
						
						<td style="text-align: right;"><?php echo 'IDR '. format_ribuan($data->total_pinjaman) ?></td>
						<td style="text-align: right;"><?php echo 'IDR '. format_ribuan($data->sisa) ?></td>
						<td><?php echo $data->tenor.'  Bulan' ?></td>
						<td><?php echo $data->status_pinjaman ?></td>
						<td><?php echo TanggalIndo($data->tgl_pelunasan) ?></td>
						<td>
												<a class="btn btn-success"><i class="fa fa-check" style="color:white;"> </i></a>
												<?php if ($this->session->userdata("level")=='admin') {
										?>
                                                <a onclick="return confirm('Yakin ingin menghapus data ?')"  href="pinjaman/hapus_pinjaman/<?php echo $data->id_pinjaman ?>" class="btn btn-danger"><i class="fa fa-trash" style="color:white;"> </i></a>
                                                <?php } ?>
                                                </td>
					...
					?>
						...
						<td>
												<a onclick="return confirm('Ingin Melihat Detail ?')"  href="pinjaman/detail_pinjaman/<?php echo $data->id_pinjaman ?>" class="btn btn-reset"><i class="fa fa-close" style="color:white;"> </i></a>
                                                <a class="btn btn-danger"><i class="fa fa-trash" style="color:white;"> </i></a>
                                                </td>
						<?php } ?>
