...
<html>
<head>
<title>Edit Kategori Pinjaman</title>
...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-pencil"> Edit Kategori Pinjaman</a></h2>
				<?php foreach ($ambil as $data) {
 					
 				?>
				<form action="<?php echo base_url().'kategori_pinjaman/update_kategori_pinjaman'; ?>" method="post">
				  <div class="form-group">
				  <div class="row mb40">
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Kode Kategori Pinjaman</label>
					    <input type="text" class="form-control" name="kode_kategori_pinjaman" value="<?php echo $data->kode_kategori_pinjaman; ?>" readonly>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Nama Pinjaman</label>
						<input style="margin-bottom: 10px;" required="" type="text" class="form-control" name="nama_pinjaman" value="<?php echo $data->nama_pinjaman; ?>">
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Persentase Pinjaman</label>
					    <input type="text" class="form-control" required="" name="persentase_pinjaman" value="<?php echo $data->persentase_pinjaman; ?>" >
					</div>
