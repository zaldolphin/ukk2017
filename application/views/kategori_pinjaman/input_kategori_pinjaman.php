...
<html>
<head>
<title>Input Kategori Pinjaman</title>
...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-pencil"> Input Kategori pinjaman</a></h2>
				<form action="<?php echo base_url().'kategori_pinjaman/input_aksi'; ?>" method="post">
				  <div class="form-group">
				  <div class="row mb40">
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Kode Kategori pinjaman</label>
					    <input type="text" class="form-control" name="kode_kategori_pinjaman" value="<?php echo $kode; ?>" readonly>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Nama pinjaman</label>
						<input style="margin-bottom: 10px;" type="text" class="form-control" name="nama_pinjaman" required="">
					</div>
					
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Persentase Pinjaman</label>
					    <input type="text" class="form-control" name="persentase_pinjaman" required="">
					</div>
