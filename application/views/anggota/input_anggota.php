...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-group"> Input Anggota</a></h2>
				<form action="<?php echo base_url().'anggota/input_aksi'; ?>" method="post" enctype="multipart/form-data">
				  <div class="form-group">
				  <div class="row mb40">
					    <input type="hidden" class="form-control" name="id_anggota" required="" value="<?php echo $kode; ?>" readonly>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Foto</label>
					    <input type="file" class="form-control" name="foto">
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Nama</label>
						<input style="margin-bottom: 10px;" type="text" class="form-control" name="nama" required="">
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<input style="margin-bottom: 10px;" type="text" class="form-control" name="no_tlp" required="">
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-2">
						<label for="exampleInputName2"><b>Tanggal</label>
						<input type="text" class="form-control" name="tanggal" required="">
					</div>
					<div class="col-md-2">
						<label for="exampleInputName2"><b>Bulan</label>
					...
					<div class="col-md-2">
						...
						<input style="margin-bottom: 10px;" type="text" class="form-control" name="tahun" required="">
					</div>
					<div class="col-md-6">
