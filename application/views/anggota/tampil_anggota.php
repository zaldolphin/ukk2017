...
<div class="agile-grids">	
				...
				<div class="agile-tables">
				  ...
				  <h3><a style="margin-left:15px; margin-top:10px;" href="input_anggota" class="fa fa-plus"><i class="btn-icon-only/ icon-plus"> </i>Tambah Data</a></h3>
				  <table width="100%" id="example1" class="max-height">
					<thead>
					  <tr>
						<th width="2%"><center>ID</th>
						<th width="25%"><center>Nama</th>
						<th><center>Alamat</th>
						<th><center>No Tlp</th>
						<th><center>Foto</th>
						<th width="23%"><center>Aksi</th>
					  </tr>
					</thead>
					<tbody>
					<?php foreach ($ambil as $data) {
					  ...
					  <tr>
						...
						<td style="text-align:center;"><img class="center-cropped" src="uploads/<?php echo $data->foto; ?>"></td>
						<td>
												<a href="anggota/detail_anggota/<?php echo $data->id_anggota  ?>" class="btn btn-success"><i class="fa fa-user" style="color:white;">  </i></a>
												<?php if ($this->session->userdata("level")=='admin') {
										?>
                                                <a onclick="return confirm('Yakin ingin mengedit data ?')"  href="anggota/edit_anggota/<?php echo $data->id_anggota  ?>" class="btn btn-primary"><i class="fa fa-refresh" style="color:white;">  </i></a>
                                                <?php } ?>
                                                <a onclick="return confirm('Yakin ingin mencetak kartu anggota ?')"  href="anggota/print_anggota/<?php echo $data->id_anggota ?>" target="_blank" class="btn btn-danger"><i class="fa fa-print" style="color:white;"> </i></a>
                                                <a onclick="return confirm('Yakin ingin keluar ?')"  href="anggota/keluar_anggota/<?php echo $data->id_anggota ?>" target="_blank" class="btn btn-reset"><i class="fa fa-sign-out" style="color:white;"> </i></a></td>
