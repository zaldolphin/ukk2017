...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-group"> Edit Anggota</a></h2>
				...
				<form action="<?php echo base_url().'anggota/update_anggota'; ?>" method="post">
				  ...
				  <div class="row mb40">
					<div class="col-md-6">
					    ...
					    <input type="text" class="form-control" name="id_anggota" required="" value="<?php echo $data->id_anggota; ?>" readonly>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Nama</label>
						<input style="margin-bottom: 10px;" type="text" value="<?php echo $data->nama; ?>" class="form-control" name="nama" required >
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Alamat</label>
					    <input type="text" class="form-control" value="<?php echo $data->alamat; ?>" name="alamat" required>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>No Tlp</label>
						<input style="margin-bottom: 10px;" type="text" value="<?php echo $data->no_tlp; ?>" class="form-control" name="no_tlp" required>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Tempat Lahir</label>
					    <input type="text" class="form-control" value="<?php echo $data->tempat_lahir; ?>" name="tempat_lahir" required>
					</div>
					
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Tahun</label>
						<input style="margin-bottom: 10px;" type="text" value="<?php echo $data->tgl_lahir; ?>" class="form-control" name="tgl_lahir" readonly>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Jenis Kelamin</label>
					    <select name="jen_kel" class="form-control">
							<option value="Pria" <?php echo $data->jen_kel == 'Pria' ? ' selected="selected"' : '';?> >Pria
							</option>
                            <option value="Wanita" <?php echo $data->jen_kel == 'Wanita' ? ' selected="selected"' : '';?>>Wanita</option>
						</select>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Ket</label>
					    <input type="text" class="form-control" name="ket" value="<?php echo $data->kets; ?>" required>
					</div>
