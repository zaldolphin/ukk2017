...
return $m;
				...
				<form target="_blank" method="post" action="<?php echo base_url().'rekap/print_rekap'; ?>">
				  ...
				  <table width="100%" id="example1" class="max-height">
					...
					<?php foreach ($ambil as $data) {
					  ...
					  <tr>
						...
						<td style="text-align: right;"><?php echo format_ribuan($data->nominal) ?></td>
