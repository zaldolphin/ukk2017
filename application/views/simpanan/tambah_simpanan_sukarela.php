...
?>
      ...
      function calc(){
      simpanan = document.nabung.besar_simpanan.value;
      tambahan = document.nabung.tambahan.value;
      document.nabung.total_tabungan.value = (simpanan * 1) + (tambahan * 1);
      }
      function stopCalc(){
...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-pencil"> Menabung Simpanan Sukarela</a></h2>
				<form action="<?php echo base_url().'simpanan/tabung_sukarela'; ?>" target="_blank" method="post" name="nabung">
				  ...
				  <div class="row mb40">
					...
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Tambahan</label>
					...
					<div class="col-md-6">
						<button onclick="return confirm('Yakin ingin Menabung Simpanan Sukarela ?')" type="submit" class="btn btn-success">Submit</button>
