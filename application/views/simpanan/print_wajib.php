...
return $m;
                  ...
                  <center><h3 style="margin-left:190px;">Bukti Transaksi Simpanan Wajib</h3></center>
                  ...
                  <table>
                    <tr>
                      ...
                      <td>:</td>
                      <td style="font-size: 12;" >Simpanan Wajib Bulan <?php echo substr(TanggalIndo($data->tgl_simpanan),2); ?></td>
                    </tr>
                    <tr>
