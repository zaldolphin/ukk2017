...
return $m;
				  ...
				  ?>
<div class="agile-grids">	<br>
				<!-- tables -->
				<h4><b>* Data Yang Belum Bayar Simpanan Wajib Bulan Ini</b></h4>
				<table>
									<tr>
						<td><b>ID</td>
						<td><b>Nama</td>
					...
					<?php foreach ($belum_bayar as $datas) {
					# code...
				?>

					<tr>
						<td><?php echo $datas->id_anggota ?></td>
						<td><?php echo $datas->nama ?></td>
						<td><?php echo $datas->alamat ?></td>
						<td><?php echo $datas->no_tlp ?></td>
					</tr>
					<?php } ?>
				</table>
				...
				<div class="agile-tables">
				  ...
				  <h3><a style="margin-left:15px; margin-top:10px;" href="input_simpanan_wajib" class="fa fa-plus"><i class="btn-icon-only/ icon-plus"> </i>Tambah Data</a></h3>
				  ...
				  <table width="100%" id="example1" class="max-height">
					...
					<?php foreach ($ambil as $data) {
					  ...
					  <tr>
						...
						<td>
                                                <a onclick="return confirm('Yakin ingin print data ?')"  href="simpanan/print_wajib/<?php echo $data->id_simpanan  ?>" target="_blank" class="btn btn-success"><i class="fa fa-print" style="color:white;"> </i></a>
                                                <?php if ($this->session->userdata("level")=='admin') {
										?>
                                                <a onclick="return confirm('Yakin ingin menghapus data ?')"  href="simpanan/hapus_simpanan_wajib/<?php echo $data->id_simpanan ?>" class="btn btn-danger"><i class="fa fa-trash" style="color:white;"> </i></a> <?php } ?> </td>
