...
return $m;
                  ...
                  <center><h3 style="margin-left:190px;">Bukti Transaksi Simpanan Pokok</h3></center>
                  ...
                  <table>
                    <tr>
                      ...
                      <td>:</td>
                      <td style="font-size: 12;" >Simpanan Pokok</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="font-size: 12;" ><b>Keterangan</td>
                      <td>:</td>
                      <td style="font-size: 12;" ><?php echo $data->ket_simpanan; ?></td>
                    </tr>
                  </table>
                  <table width="100%">
                  <tr>
