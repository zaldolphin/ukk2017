...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-pencil"> Input Simpanan Wajib</a></h2>
				<form action="<?php echo base_url().'simpanan/input_aksi_wajib'; ?>" method="post">
				  ...
				  <div class="row mb40">
					...
					<div class="col-md-6">
					    ...
					    <input style="margin-bottom: 10px;" type="text" class="form-control" value="KTS002" name="kode_kategori_simpanan" readonly="">
					</div>
					...
					<div class="col-md-6">
					    ...
					    <input style="margin-bottom: 10px;" type="number" class="form-control" value="100000" name="besar_simpanan" readonly="">
					</div>
