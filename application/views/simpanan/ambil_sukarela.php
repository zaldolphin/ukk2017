...
return $m;
                  ...
                  <center><h3 style="margin-left:160px;">Bukti Transaksi Pengambilan Simpanan Sukarela</h3></center>
                  ...
                  <table>
                    <tr>
                      ...
                      <td>:</td>
                      <td style="font-size: 12;" >Pengambilan Simpanan Sukarela</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="font-size: 12;" ><b>Nominal Pengambilan</td>
                      <td>:</td>
                      <td style="font-size: 12;" ><?php echo 'IDR '. format_ribuan($blabla); ?></td>
                    </tr>
                    <tr>
                      <td style="font-size: 12;" ><b>Sisa Simpanan</td>
                      <td>:</td>
