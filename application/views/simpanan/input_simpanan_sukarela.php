...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-pencil"> Input Simpanan Sukarela</a></h2>
				<form action="<?php echo base_url().'simpanan/insert_simpanan_sukarela'; ?>" target="_blank" method="post">
				  <div class="form-group">
				  <div class="row mb40">
					<div class="col-md-6">
						<label for="exampleInputName2"><b>ID Simpanan</label>
					    <input type="text" class="form-control" name="id_simpanan" value="<?php echo $kode; ?>" readonly>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Besar Simpanan</label>
						<input style="margin-bottom: 10px;" type="hidden" id="besar2" class="form-control" name="besar_simpanan" required="">

						<input style="margin-bottom: 10px;" type="text" id="besar" class="form-control" required="">
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Keterangan</label>
					    <input type="text" class="form-control" name="ket_simpanan">
					</div>
					
					<div class="col-md-6">
						<button style="margin-top: 25px;" type="submit" class="btn btn-success">Submit</button>
						<a style="margin-top: 25px;" href="<?php echo base_url('simpanan_sukarela') ?>" class="btn btn-warning"><i class="btn-icon-only/ fa fa-rotate-left"> </i> Kembali</a>
					</div>
				  </div>
