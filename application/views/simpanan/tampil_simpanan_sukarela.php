...
<div class="agile-grids">	
				...
				<h3><a style="margin-left:15px; margin-top:10px;" href="input_simpanan_sukarela" class="fa fa-plus"><i class="btn-icon-only/ icon-plus"> </i>Tambah Data</a></h3>
				  <?php
				  ...
				  <table width="100%" id="example1" class="max-height">
					...
					<?php foreach ($ambil as $data) {
					  ...
					  <tr>
						...
						<td>
                                                <a onclick="return confirm('Anda yakin ingin menabung ?')"  href="simpanan/tambah_simpanan_sukarela/<?php echo $data->id_simpanan  ?>" class="btn btn-primary"><i class="fa fa-plus" style="color:white;"> </i> Menabung</a>
                                                <a onclick="return confirm('Anda yakin ingin mengambil uang ?')"  href="simpanan/ambil_simpanan_sukarela/<?php echo $data->id_simpanan ?>" class="btn btn-danger"><i class="fa fa-minus" style="color:white;"> </i> Mengambil</a></td>
