...
<div class="agile-grids">	
				...
				<div class="agile-tables">
				  ...
				  <h3><a style="margin-left:15px; margin-top:10px;" href="input_kategori_simpanan" class="fa fa-plus"><i class="btn-icon-only/ icon-plus"> </i>Tambah Data</a></h3>
				  <table width="100%" id="example1" class="max-height">
					<thead>
					  <tr>
						<th width="25%"><center>ID</th>
						<th width="50%"><center>Nama</th>
						<th><center>Aksi</th>
					  </tr>
					</thead>
					<tbody>
					<?php foreach ($ambil as $data) {
				  	?>
					  <tr>
						<td><?php echo $data->kode_kategori_simpanan ?></td>
						<td><?php echo $data->nama_simpanan ?></td>
						<td>
                                                <a onclick="return confirm('Yakin ingin mengedit data ?')"  href="kategori_simpanan/edit_kategori_simpanan/<?php echo $data->kode_kategori_simpanan  ?>" class="btn btn-primary"><i class="fa fa-refresh" style="color:white;"> </i> Edit</a>
                                                <a onclick="return confirm('Yakin ingin menghapus data ?')"  href="kategori_simpanan/hapus_kategori_simpanan/<?php echo $data->kode_kategori_simpanan ?>" class="btn btn-danger"><i class="fa fa-trash" style="color:white;"> </i> Hapus</a></td>
