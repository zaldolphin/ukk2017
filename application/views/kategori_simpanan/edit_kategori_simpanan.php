...
<html>
<head>
<title>Edit Kategori Simpanan</title>
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-pencil"> Input Kategori Simpanan</a></h2>
				<?php foreach ($ambil as $data) {
 				...
 				?>
				<form action="<?php echo base_url().'kategori_simpanan/update_kategori_simpanan'; ?>" method="post">
				  <div class="form-group">
				  <div class="row mb40">
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Kode Kategori Simpanan</label>
					    <input type="text" class="form-control" name="kode_kategori_simpanan" value="<?php echo $data->kode_kategori_simpanan; ?>" readonly>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Nama Simpanan</label>
						<input style="margin-bottom: 10px;" type="text" class="form-control" name="nama_simpanan" value="<?php echo $data->nama_simpanan; ?>" required>
					</div>
