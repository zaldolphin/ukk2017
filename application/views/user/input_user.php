...
<div class="left-content">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class=""><a class="fa fa-group"> Input User</a></h2>
				<form action="<?php echo base_url().'user/input_aksi'; ?>" method="post">
				  <div class="form-group">
				  <div class="row mb40">
					<div class="col-md-6">
						<label for="exampleInputName2"><b>ID User</label>
					    <input type="text" class="form-control" name="id_user" value="<?php echo $kode; ?>" readonly>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>ID Petugas</label>
						<input type="text" style="margin-bottom: 10px;" class="form-control" name="id_petugas" value="<?php echo $kodes; ?>" readonly>
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Nama Anggota</label>
						
					    <select name="id_anggota" class="form-control" required="">
					    <?php foreach ($ambil_anggota as $data) {
						?>
					...
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Username</label>
						<input type="text" style="margin-bottom: 10px;" class="form-control" name="username">
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Password</label>
					    <input type="password" class="form-control" name="password">
					</div>
					<div class="col-md-6">
						<label for="exampleInputName2"><b>Level</label>
					    <select style="margin-bottom: 10px;" name="level" class="form-control">
