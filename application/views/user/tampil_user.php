...
<div class="agile-grids">	
				...
				<div class="agile-tables">
				  ...
				  <h3><a style="margin-left:15px; margin-top:10px;" href="input_user" class="fa fa-plus"><i class="btn-icon-only/ icon-plus"> </i>Tambah Data</a></h3>
				  <table id="example1" class="max-height">
					<thead>
					  <tr>
					...
					<?php foreach ($ambil as $data) {
					  ...
					  <tr>
						...
						<?php if ($this->session->userdata("level")=='admin') {
										?>
						<td>
                                                <a onclick="return confirm('Yakin ingin menghapus data ?')"  href="user/hapus_user/<?php echo $data->id_petugas ?>" class="btn btn-danger"><i style="color:white;" class="fa fa-trash"> </i> Hapus</a></td> <?php } ?>
